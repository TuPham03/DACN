                        ...
                        <table className='w-full'>
                            <tbody className='w-full'>
                                ...
                                <td className='p-2'>
                                        {posts[0]?.user?.fbUrl ? (
                                            <a
                                            href={posts[0]?.user?.fbUrl}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="text-blue-600 underline font-bold hover:text-orange-600 hover:underline cursor-pointer"
                                            >
                                            {posts[0]?.user?.fbUrl} {/* Chỉ hiển thị văn bản của URL */}
                                            </a>
                                        ) : (
                                            "Không có thông tin"
                                        )}
