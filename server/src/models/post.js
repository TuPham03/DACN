...
module.exports = (sequelize, DataTypes) => {
  class Post extends Model {
    ...
    static associate(models) {
      ...
      //Post.belongsTo(models.VipCost, { foreignKey: 'id', targetKey: 'id', as: 'vipCost' })
      Post.belongsTo(models.VipCost, { foreignKey: 'vipcost_id', as: 'vipCost' });
  ...
  Post.init(
    {
      ...
      vipCost_time : DataTypes.BIGINT,
      vipcost_id : DataTypes.INTEGER,
